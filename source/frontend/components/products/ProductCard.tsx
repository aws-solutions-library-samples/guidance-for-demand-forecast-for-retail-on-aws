...
const productCardVariants = cva('rounded-lg border p-6 transition-all duration-200', {
  variants: {
    state: {
...
export const ProductCard = forwardRef<HTMLDivElement, ProductCardProps>(
  ({ product, onSelect, selected = false, showActions: _ = false }, ref) => {
    ...
    return (
      ...
      >
        ...
        <p className="text-xs text-muted-foreground uppercase tracking-wider">{product.itemType}</p>
      ...
      <CardContent className="p-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <span className="font-mono text-xs text-muted-foreground">{product.itemId}</span>
